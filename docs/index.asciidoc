...
=== Rfc6587 codec plugin

include::{include_path}/plugin_header.asciidoc[]

==== Description

Reads data as described by rfc6587.

Decoding behavior:: Only whole line events are emitted.

Encoding behavior:: Not implemented yet.
...
==== Rfc6587 codec configuration options
